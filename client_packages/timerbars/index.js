...
mp.events.add("render", () => {
    ...
    for (let i = 0; i < max; i++) {
        ...
        if (activeTimerBars[i].useProgressBar) {
            ...
            // draw background
            mp.game.graphics.drawRect(pbarX, pbarY, Sizes.pbarWidth, Sizes.pbarHeight, activeTimerBars[i].pbarBgColor[0], activeTimerBars[i].pbarBgColor[1], activeTimerBars[i].pbarBgColor[2], activeTimerBars[i].pbarBgColor[3]);

            // draw foreground
            mp.game.graphics.drawRect((pbarX - Sizes.pbarWidth / 2) + width / 2, pbarY, width, Sizes.pbarHeight, activeTimerBars[i].pbarFgColor[0], activeTimerBars[i].pbarFgColor[1], activeTimerBars[i].pbarFgColor[2], activeTimerBars[i].pbarFgColor[3]);
        } else {
            // draw text
