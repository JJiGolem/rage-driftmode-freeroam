...
let vehInfoItem = new UIMenuCheckboxItem("Vehicle Info", false);
...
dr.driftMenu.CheckboxChange.on((item, checked) => {
    ...
    if(dlEnabled)
        mp.gui.chat.push("!{#0099ff}[Vehicle Info] !{White}Showing.");
    else
        mp.gui.chat.push("!{#0099ff}[Vehicle Info] !{White}Hiding.");
});
